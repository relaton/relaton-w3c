RSpec.describe RelatonW3c::DataIndex do
  ...
  context "instance" do
    it "add record to index" do
      pubid = RelatonW3c::PubId.new code: "bib"
      subject.add pubid, "dir/bib.xml"
      expect(subject.instance_variable_get(:@index)).to eq [{ file: "dir/bib.xml", code: "bib" }]
    end

    it "update record in index" do
      pubid1 = RelatonW3c::PubId.new code: "bib1"
      pubid2 = RelatonW3c::PubId.new code: "bib2"
      subject.add pubid1, "dir/bib.xml"
      subject.add pubid2, "dir/bib.xml"
