...
RSpec.describe RelatonW3c do
  ...
  context "get document" do
    ...
    #   VCR.use_cassette "data" do
    #     VCR.use_cassette "cr_css_images_3" do
    #       doc = RelatonW3c::W3cBibliography.get "W3C CR-css-images-3-20191010"
    #       expect(doc.title.first.title.content).to eq "JSON-LD 1.1"
    #       expect(doc.doctype).to eq "candidateRecommendation"
    #     end
    #   end
    ...
    context "from history" do
      ...
      #       expect(doc.title.first.title.content).to eq "Document Object Model (DOM) Level 3 Core Specification"
      #     end
      #   end
      # end
